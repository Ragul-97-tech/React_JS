...
export default function ThemeToggler({ mode, action }) {
    return (
        <div onClick={action} style={{display: "inline-flex", justifyContent: "center", alignItems: "center", cursor: "pointer", padding: "0.5rem"}}>
            {mode ?
